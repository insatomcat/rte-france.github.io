...
Within the [SEAPATH project](https://opensource.rte-france.com/projects/seapath), to which RTE contributes, FAI is used to build the Debian-based installation media. RTE also contributes fixes and proposes enhancements to FAI based on issues and needs identified during SEAPATH development.
